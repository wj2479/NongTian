 ...
 * 日报每日统计
 */
class ReportDayCountFragment : BaseFragment() {
    ...
    override fun intiLayout(): Int {
        return R.layout.fragment_report_day_count
    }
    ...
    private fun initWheelYearMonthDayDialog() {
        // ------------------------------------------------------------------选择日期开始
        mRxDialogWheelYearMonthDay = RxDialogWheelYearMonthDay(context)
                ...
                .subscribe(object : Consumer<String> {
                    override fun accept(result: String?) {
                        ...
                        if (json.getInt("code") == 1000) {
                            ...
                            Log.e("TAG", "获取日统计结果成功:" + jArray.toString())
                            if (jArray.length() > 0) {
